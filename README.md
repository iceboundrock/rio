...
| Shared JSON Schema, validated on both sides | One contract, executable in backend tests (networknt `json-schema-validator`, Draft 2020-12, `pattern`s matched by joni in ECMAScript mode as Ajv does, RFC 8259 grammar checked before validating) and at frontend runtime (Ajv). |
